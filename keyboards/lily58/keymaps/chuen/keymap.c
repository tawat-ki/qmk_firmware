...
[_D] = LAYOUT(
  ...
  MO(_N), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    TO(_G),  TO(_M), KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_BSLS,
                             KC_LGUI, MO(_L),  KC_LSFT,  KC_SPC,  KC_ENT, MO(_R),  KC_RGUI, KC_LALT
),
...
[_M] = LAYOUT(
  ...
  _______, XXXXXXX, XXXXXXX, KC_MS_D, KC_MS_U, XXXXXXX, TO(_G),  TO(_M),  XXXXXXX, KC_WH_L, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                             _______, _______, _______, KC_BTN1, KC_BTN2, MO(_N), _______, _______
),
