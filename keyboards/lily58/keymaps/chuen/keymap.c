 ...
 * |  FN  |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   /  |  \   |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LCTL | LGUI |LShift| /Space  /       \Enter \  | ESC  | BSPC |LAlt  |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
[_D] = LAYOUT(
  ...
  MO(_FN), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    TO(_GM), TO(_M),  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_BSLS,
                             KC_LCTL, KC_LGUI, KC_LSFT, KC_SPC,  KC_ENT,  KC_ESC,  KC_BSPC, KC_LALT
),
//FUNCTION
[_FN] = LAYOUT(
  ...
  KC_CAPS, XXXXXXX, XXXXXXX, KC_PGDN, KC_PGUP, XXXXXXX,                   KC_DEL,  KC_LEFT, KC_TAB,  XXXXXXX, KC_END,  XXXXXXX,
  _______, XXXXXXX, XXXXXXX, KC_DOWN, KC_UP,   XXXXXXX, TO(_D),  TO(_DV), XXXXXXX, KC_HOME, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
...
//GAME MODE
  ...
  KC_SPC,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    TO(_GM), TO(_M),  DM_PLY1, DM_PLY2, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                             KC_LCTL, KC_GRV,  KC_LSFT, KC_LALT, DM_RSTP, TO(_D),  XXXXXXX, XXXXXXX
),
//MOUSE
[_M] = LAYOUT(
...
[_DV] = LAYOUT(
  ...
  KC_LBRC, KC_QUOT, KC_COMM, KC_DOT,  KC_P,    KC_Y,                      KC_F,    KC_G,    KC_C,    KC_R,    KC_L,    KC_SLSH,
  KC_RBRC, KC_A,    KC_O,    KC_E,    KC_U,    KC_I,                      KC_D,    KC_H,    KC_T,    KC_N,    KC_S,    KC_MINS,
  MO(_FN), KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,    TO(_GM), TO(_M),  KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    KC_BSLS,
                             KC_LCTL, KC_LGUI, KC_LSFT, KC_SPC,  KC_ENT,  KC_ESC,  KC_BSPC, KC_LALT
),
