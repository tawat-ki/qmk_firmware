 ...
 * |  FN  |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   /  |  \   |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LCTL | LGUI |LShift| /Space  /       \Enter \  | ESC  | LAlt |MOUSE |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
[_D] = LAYOUT(
  ...
  KC_DEL,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    TO(_GM), TO(_M),  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_BSLS,
                             KC_LCTL, KC_LGUI, KC_LSFT,  KC_SPC,  KC_ENT, KC_ESC,  MO(_FN), KC_RALT
),
//FUNCTION
[_FN] = LAYOUT(
...
[_DV] = LAYOUT(
  ...
  KC_DEL,  KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,    TO(_GM), TO(_M),  KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    KC_BSLS,
                             KC_LCTL, KC_LGUI, KC_LSFT, KC_SPC,  KC_ENT,  KC_ESC,  MO(_FD), KC_LALT
),
